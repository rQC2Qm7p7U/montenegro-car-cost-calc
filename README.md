...
- Live FX updates for KRW/USD and EUR/USD via exchangerate-api.com with range validation, fallback rates, and manual override plus optional auto-refresh.
...
- `src/utils/currency.ts` – FX fetching with sane bounds plus format/parse helpers for KRW↔USD and USD↔EUR.
